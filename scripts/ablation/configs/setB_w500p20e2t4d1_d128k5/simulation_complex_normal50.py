"""Set B: Simulation complex with 50% label noise (p20, d128, k5)"""

DATASET_TYPE = 'simulation_complex'
PHASE_NAME = "simulation_complex_normal50"
PHASE_DESCRIPTION = "Simulation complex with 50% label noise (p20, d128, k5)"
