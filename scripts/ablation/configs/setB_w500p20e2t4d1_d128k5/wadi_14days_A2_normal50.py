"""Set B: WaDi 14days + A2 with 50% label noise (p20, d128, k5)"""

DATASET_TYPE = 'wadi_14days_A2'
PHASE_NAME = "wadi_14days_A2_normal50"
PHASE_DESCRIPTION = "WaDi 14days + A2 with 50% label noise (p20, d128, k5)"
