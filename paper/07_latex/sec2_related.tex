...
Our approach differs along this axis: labeled anomaly information enters the gradient of the encoder during training itself, through co-designed mechanisms that shape what the model learns to represent rather than what it predicts.
We are not aware of prior end-to-end MTSAD work that integrates labeled anomalies into the gradient of a masked-reconstruction self-distillation objective through gradient reversal.
