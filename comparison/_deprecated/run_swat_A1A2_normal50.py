#!/usr/bin/env python
"""
Run Comparison Experiments on SWaT A1A2 Normal50 Dataset
...
Usage:
    ...
    python comparison/run_swat_A1A2_normal50.py
    python comparison/run_swat_A1A2_normal50.py --only-simple
    python comparison/run_swat_A1A2_normal50.py --skip-sota
"""
...
from comparison.data.swat_normal50_loader import SWaTNormal50Loader
...
def main():
    parser = argparse.ArgumentParser(description='Run SWaT A1A2 Normal50 baselines')
    ...
    loader = SWaTNormal50Loader(remove_unlabeled=True)
    loader.load()
    ...
    print(f"\nDataset: SWaT A1A2 Normal50 (Baseline mode)")
    ...
    print("-" * 70)
    print("\nDone! To add MAE results, run:")
    print(f"  python comparison/add_mae_swat_normal50_results.py")
