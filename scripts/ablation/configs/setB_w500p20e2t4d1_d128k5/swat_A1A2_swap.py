"""Set B: SWaT A1+A2 with swapped A2 halves (p20, d128, k5)"""

DATASET_TYPE = 'swat_A1A2_swap'
PHASE_NAME = "swat_A1A2_swap"
PHASE_DESCRIPTION = "SWaT A1+A2 with swapped A2 halves (p20, d128, k5)"
