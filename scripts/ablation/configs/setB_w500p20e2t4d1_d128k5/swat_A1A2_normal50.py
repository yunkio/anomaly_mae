"""Set B: SWaT A1+A2 with 50% label noise (p20, d128, k5)"""

DATASET_TYPE = 'swat_A1A2'
PHASE_NAME = "swat_A1A2_normal50"
PHASE_DESCRIPTION = "SWaT A1+A2 with 50% label noise (p20, d128, k5)"
